...
from readeck_cli.infrastructure.readeck_client.models.user_profile import UserProfile
...
class UserProfileApi:
    ...
    def profile_get(
        ...
        This route returns the current user's profile information. This includes the user information and preferences, and the authentication provider with its permissions.  **Note**: This route is available with any OAuth scope but you only receive extended profile information, such as `user.email`, with the `profile:read` scope. 
