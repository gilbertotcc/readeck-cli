...
from readeck_cli.infrastructure.readeck_client.models.oauth_client_create import OauthClientCreate
from readeck_cli.infrastructure.readeck_client.models.oauth_client_response import OauthClientResponse
from readeck_cli.infrastructure.readeck_client.models.oauth_device import OauthDevice
from readeck_cli.infrastructure.readeck_client.models.oauth_device_create import OauthDeviceCreate
from readeck_cli.infrastructure.readeck_client.models.oauth_revoke_post_request import OauthRevokePostRequest
from readeck_cli.infrastructure.readeck_client.models.oauth_token_create import OauthTokenCreate
from readeck_cli.infrastructure.readeck_client.models.oauth_token_response import OauthTokenResponse
...
class OauthApi:
    ...
    @validate_call
    def oauth_client_post(
        self,
        oauth_client_create: Optional[OauthClientCreate] = None,
        ...
        This route creates a new OAuth client. You must create a new client before you can request permissions and receive a token.  Please refer to the [Client Registration Documentation](#overview--client-registration) for more details.  This route implements [RFC 7591: OAuth 2.0 Dynamic Client Registration Protocol](https://datatracker.ietf.org/doc/html/rfc7591).  Note: checks on `token_endpoint_auth_method` and `response_types` are enforced but their respective values are not used internaly. 

        :param oauth_client_create:
        :type oauth_client_create: OauthClientCreate
        ...
        _param = self._oauth_client_post_serialize(
    ...
    @validate_call
    def oauth_client_post_with_http_info(
        self,
        oauth_client_create: Optional[OauthClientCreate] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OauthClientResponse]:
        """Client Registration
    ...
    @validate_call
    def oauth_client_post_without_preload_content(
        self,
        oauth_client_create: Optional[OauthClientCreate] = None,
        _request_timeout: Union[
            None,
    ...
    def _oauth_client_post_serialize(
        self,
        oauth_client_create,
        _request_auth,
        _content_type,
        ...
        if oauth_client_create is not None:
            _body_params = oauth_client_create
    ...
    @validate_call
    def oauth_device_post(
        self,
        oauth_device_create: Optional[OauthDeviceCreate] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This route is the device authorization request. A client must call it first, with its client ID and a scope list it wants to grant a device.  Please refer to [OAuth Device Code Flow](#overview--oauth-device-code-flow) for more information. 

        :param oauth_device_create:
        :type oauth_device_create: OauthDeviceCreate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._oauth_device_post_serialize(
            oauth_device_create=oauth_device_create,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def oauth_device_post_with_http_info(
        self,
        oauth_device_create: Optional[OauthDeviceCreate] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def oauth_device_post_without_preload_content(
        self,
        oauth_device_create: Optional[OauthDeviceCreate] = None,
        _request_timeout: Union[
            None,
    ...
    def _oauth_device_post_serialize(
        self,
        oauth_device_create,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if oauth_device_create is not None:
            _body_params = oauth_device_create
    ...
    def oauth_revoke_post(
        ...
        This route lets a client revokes an access token. It must authenticate using the same access token than the one provided in the request body.  You can use this route if you want to provide a log-out option to users. 
    ...
    def oauth_token_post(
        self,
        oauth_token_create: Optional[OauthTokenCreate] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        A client must call this route once it received the necessary information from the redirect URI generated by the authorization route.  Please refer to:  - [OAuth Authorization Code Flow](#overview--oauth-authorization-code-flow) for details about the authorization code flow - [OAuth Device Code Flow](#overview--oauth-device-code-flow) for details about the device code flow 

        :param oauth_token_create:
        :type oauth_token_create: OauthTokenCreate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._oauth_token_post_serialize(
            oauth_token_create=oauth_token_create,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _oauth_token_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if oauth_token_create is not None:
            _body_params = oauth_token_create
