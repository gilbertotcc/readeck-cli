...
from typing_extensions import Annotated
from readeck_cli.infrastructure.readeck_client.models.annotation_create import AnnotationCreate
from readeck_cli.infrastructure.readeck_client.models.annotation_info import AnnotationInfo
from readeck_cli.infrastructure.readeck_client.models.annotation_summary import AnnotationSummary
from readeck_cli.infrastructure.readeck_client.models.annotation_update import AnnotationUpdate
from readeck_cli.infrastructure.readeck_client.models.bookmarks_id_annotations_annotation_id_patch200_response import BookmarksIdAnnotationsAnnotationIdPatch200Response
...
class BookmarkHighlightsApi:
    ...
    def bookmarks_annotations_get(
        ...
        _param = self._bookmarks_annotations_get_serialize(
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def bookmarks_annotations_get_with_http_info(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of items per page")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Pagination offset")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[AnnotationSummary]]:
        """Highlight List
    ...
    @validate_call
    def bookmarks_annotations_get_without_preload_content(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of items per page")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Pagination offset")] = None,
        _request_timeout: Union[
    ...
    def _bookmarks_annotations_get_serialize(
        self,
        limit,
        offset,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bookmarks/annotations',
    ...
    @validate_call
    def bookmarks_id_annotations_annotation_id_delete(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        annotation_id: Annotated[StrictStr, Field(description="Highlight ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: str
        :param annotation_id: Highlight ID (required)
        ...
        _param = self._bookmarks_id_annotations_annotation_id_delete_serialize(
            id=id,
    ...
    @validate_call
    def bookmarks_id_annotations_annotation_id_delete_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        annotation_id: Annotated[StrictStr, Field(description="Highlight ID")],
        _request_timeout: Union[
    ...
    @validate_call
    def bookmarks_id_annotations_annotation_id_delete_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        annotation_id: Annotated[StrictStr, Field(description="Highlight ID")],
        _request_timeout: Union[
    ...
    def _bookmarks_id_annotations_annotation_id_delete_serialize(
        self,
        id,
        annotation_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/bookmarks/{id}/annotations/{annotation_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def bookmarks_id_annotations_annotation_id_patch(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        annotation_id: Annotated[StrictStr, Field(description="Highlight ID")],
        ...
        This route updates the given highlight in the given bookmark. 
        ...
        _param = self._bookmarks_id_annotations_annotation_id_patch_serialize(
            id=id,
            annotation_id=annotation_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "BookmarksIdAnnotationsAnnotationIdPatch200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def bookmarks_id_annotations_annotation_id_patch_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        annotation_id: Annotated[StrictStr, Field(description="Highlight ID")],
        annotation_update: Optional[AnnotationUpdate] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BookmarksIdAnnotationsAnnotationIdPatch200Response]:
        """Highlight Update
    ...
    @validate_call
    def bookmarks_id_annotations_annotation_id_patch_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        annotation_id: Annotated[StrictStr, Field(description="Highlight ID")],
        annotation_update: Optional[AnnotationUpdate] = None,
    ...
    def _bookmarks_id_annotations_annotation_id_patch_serialize(
        self,
        id,
        annotation_id,
        annotation_update,
    ...
    @validate_call
    def bookmarks_id_annotations_get(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        _request_timeout: Union[
            None,
        ...
        _param = self._bookmarks_id_annotations_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def bookmarks_id_annotations_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bookmarks_id_annotations_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        _request_timeout: Union[
            None,
    ...
    def _bookmarks_id_annotations_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bookmarks/{id}/annotations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def bookmarks_id_annotations_post(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        annotation_create: Optional[AnnotationCreate] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._bookmarks_id_annotations_post_serialize(
            id=id,
    ...
    @validate_call
    def bookmarks_id_annotations_post_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        annotation_create: Optional[AnnotationCreate] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def bookmarks_id_annotations_post_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        annotation_create: Optional[AnnotationCreate] = None,
        _request_timeout: Union[
    ...
    def _bookmarks_id_annotations_post_serialize(
        self,
        id,
        annotation_create,
        _request_auth,
