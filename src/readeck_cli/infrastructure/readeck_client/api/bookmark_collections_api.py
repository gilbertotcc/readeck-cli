...
from typing_extensions import Annotated
from readeck_cli.infrastructure.readeck_client.models.collection_create import CollectionCreate
from readeck_cli.infrastructure.readeck_client.models.collection_info import CollectionInfo
from readeck_cli.infrastructure.readeck_client.models.collection_summary import CollectionSummary
from readeck_cli.infrastructure.readeck_client.models.collection_update import CollectionUpdate
...
class BookmarkCollectionsApi:
    ...
    def bookmarks_collections_get(
        ...
        _param = self._bookmarks_collections_get_serialize(
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def bookmarks_collections_get_with_http_info(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of items per page")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Pagination offset")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CollectionInfo]]:
        """Collection List
    ...
    @validate_call
    def bookmarks_collections_get_without_preload_content(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of items per page")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Pagination offset")] = None,
        _request_timeout: Union[
    ...
    def _bookmarks_collections_get_serialize(
        self,
        limit,
        offset,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bookmarks/collections',
    ...
    @validate_call
    def bookmarks_collections_id_delete(
        self,
        ...
        _param = self._bookmarks_collections_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def bookmarks_collections_id_delete_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Collection ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bookmarks_collections_id_delete_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Collection ID")],
        _request_timeout: Union[
            None,
    ...
    def _bookmarks_collections_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/bookmarks/collections/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def bookmarks_collections_id_get(
        self,
        id: Annotated[StrictStr, Field(description="Collection ID")],
        _request_timeout: Union[
            None,
        ...
        _param = self._bookmarks_collections_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def bookmarks_collections_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Collection ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bookmarks_collections_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Collection ID")],
        _request_timeout: Union[
            None,
    ...
    def _bookmarks_collections_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def bookmarks_collections_id_patch(
        self,
        id: Annotated[StrictStr, Field(description="Collection ID")],
        collection_update: Optional[CollectionUpdate] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._bookmarks_collections_id_patch_serialize(
            id=id,
    ...
    @validate_call
    def bookmarks_collections_id_patch_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Collection ID")],
        collection_update: Optional[CollectionUpdate] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def bookmarks_collections_id_patch_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Collection ID")],
        collection_update: Optional[CollectionUpdate] = None,
        _request_timeout: Union[
    ...
    def _bookmarks_collections_id_patch_serialize(
        self,
        id,
        collection_update,
        _request_auth,
    ...
    @validate_call
    def bookmarks_collections_post(
        self,
        collection_create: Optional[CollectionCreate] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._bookmarks_collections_post_serialize(
    ...
    @validate_call
    def bookmarks_collections_post_with_http_info(
        self,
        collection_create: Optional[CollectionCreate] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bookmarks_collections_post_without_preload_content(
        self,
        collection_create: Optional[CollectionCreate] = None,
        _request_timeout: Union[
            None,
    ...
    def _bookmarks_collections_post_serialize(
        self,
        collection_create,
        _request_auth,
        _content_type,
