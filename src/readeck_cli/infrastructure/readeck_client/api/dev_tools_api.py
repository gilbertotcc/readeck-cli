...
from typing_extensions import Annotated
from readeck_cli.infrastructure.readeck_client.models.cookbook_extract_get200_response import CookbookExtractGet200Response
from readeck_cli.infrastructure.readeck_client.models.cookbook_extract_params import CookbookExtractParams
...
class DevToolsApi:
    ...
    @validate_call
    def cookbook_extract_get(
        self,
        url: Annotated[str, Field(strict=True, max_length=1024, description="URL to extract")],
        ...
        This route extracts a link and returns the extraction result.  You can pass an `Accept` header to the request, with one of the following values:  - `application/json` (default) returns a JSON response - `text/html` returns an HTML response with all the media included as base64 encoded   URLs. 

        :param url: URL to extract (required)
        :type url: str
        :param accept:
        :type accept: str
        ...
        _param = self._cookbook_extract_get_serialize(
            url=url,
            accept=accept,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '401': "Message",
            '403': "Message",
            '200': "CookbookExtractGet200Response",
        }
    ...
    @validate_call
    def cookbook_extract_get_with_http_info(
        self,
        url: Annotated[str, Field(strict=True, max_length=1024, description="URL to extract")],
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CookbookExtractGet200Response]:
        """Extract Link
    ...
    @validate_call
    def cookbook_extract_get_without_preload_content(
        self,
        url: Annotated[str, Field(strict=True, max_length=1024, description="URL to extract")],
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _cookbook_extract_get_serialize(
        self,
        url,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/cookbook/extract',
    ...
    @validate_call
    def cookbook_extract_post(
        self,
        accept: Optional[StrictStr] = None,
        cookbook_extract_params: Optional[CookbookExtractParams] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Extract Link with content

        This route extracts a link and returns the extraction result.  You can pass an `Accept` header to the request, with one of the following values:  - `application/json` (default) returns a JSON response - `text/html` returns an HTML response with all the media included as base64 encoded   URLs.  To pass the entire contents of a page together with its url, send this request with the `html` field in the request body. This way, the article fetcher can use that instead of having to fetch the page at url.  You can send this request as `application/json`, `application/x-www-form-urlencoded` or `multipart/form-data`. 

        :param accept:
        :type accept: str
        :param cookbook_extract_params:
        :type cookbook_extract_params: CookbookExtractParams
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._cookbook_extract_post_serialize(
            accept=accept,
            cookbook_extract_params=cookbook_extract_params,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cookbook_extract_post_with_http_info(
        self,
        accept: Optional[StrictStr] = None,
        cookbook_extract_params: Optional[CookbookExtractParams] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def cookbook_extract_post_without_preload_content(
        self,
        accept: Optional[StrictStr] = None,
        cookbook_extract_params: Optional[CookbookExtractParams] = None,
        _request_timeout: Union[
    ...
    def _cookbook_extract_post_serialize(
        self,
        accept,
        cookbook_extract_params,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if cookbook_extract_params is not None:
            _body_params = cookbook_extract_params
    ...
    def cookbook_urls_get(
        ...
        _param = self._cookbook_urls_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cookbook_urls_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def cookbook_urls_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cookbook_urls_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
