...
class BookmarkExportApi:
    ...
    @validate_call
    def bookmarks_id_article_format_get(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        format: Annotated[StrictStr, Field(description="Export format")],
        ...
        This route exports a bookmark to another format.
        ...
        _param = self._bookmarks_id_article_format_get_serialize(
            id=id,
            format=format,
    ...
    @validate_call
    def bookmarks_id_article_format_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        format: Annotated[StrictStr, Field(description="Export format")],
        _request_timeout: Union[
    ...
    @validate_call
    def bookmarks_id_article_format_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        format: Annotated[StrictStr, Field(description="Export format")],
        _request_timeout: Union[
    ...
    def _bookmarks_id_article_format_get_serialize(
        self,
        id,
        format,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bookmarks/{id}/article.{format}',
    ...
    def bookmarks_id_article_get(
        ...
        _param = self._bookmarks_id_article_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def bookmarks_id_article_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bookmarks_id_article_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Bookmark ID")],
        _request_timeout: Union[
            None,
    ...
    def _bookmarks_id_article_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bookmarks/{id}/article',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
