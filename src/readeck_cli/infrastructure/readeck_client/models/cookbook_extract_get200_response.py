...
from readeck_cli.infrastructure.readeck_client.models.cookbook_extract_get200_response_images import CookbookExtractGet200ResponseImages
from readeck_cli.infrastructure.readeck_client.models.cookbook_extract_get200_response_properties import CookbookExtractGet200ResponseProperties
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class CookbookExtractGet200Response(BaseModel):
    """
    CookbookExtractGet200Response
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="The extracted URL")
    logs: Optional[List[StrictStr]] = Field(default=None, description="Extraction log")
    errors: Optional[List[StrictStr]] = Field(default=None, description="Extraction errors, if any")
    meta: Optional[Dict[str, List[StrictStr]]] = Field(default=None, description="Contains the meta tags extracted from the page. ")
    properties: Optional[CookbookExtractGet200ResponseProperties] = None
    domain: Optional[StrictStr] = Field(default=None, description="Page's domain name")
    title: Optional[StrictStr] = Field(default=None, description="Page's title")
    authors: Optional[String] = Field(default=None, description="Page's author list")
    site: Optional[StrictStr] = Field(default=None, description="Page's site")
    site_name: Optional[StrictStr] = Field(default=None, description="Page's site name")
    ...
    var_date: Optional[Any] = Field(default=None, description="Publication date. Can be `null` when unknown.", alias="date")
    document_type: Optional[StrictStr] = Field(default=None, description="The detected document type. The value is usualy `article`, `photo` or `video` but can vary, based on the extraction process. ")
    description: Optional[StrictStr] = Field(default=None, description="Page's short description, when it exists. It's always an unformatted text. ")
    html: Optional[StrictStr] = Field(default=None, description="The HTML content after processing. ")
    embed: Optional[StrictStr] = Field(default=None, description="The oembed HTML fragment, when it exists. It usualy contains an iframe when extracting videos. ")
    images: Optional[CookbookExtractGet200ResponseImages] = None
    __properties: ClassVar[List[str]] = ["url", "logs", "errors", "meta", "properties", "domain", "title", "authors", "site", "site_name", "lang", "text_direction", "date", "document_type", "description", "html", "embed", "images"]
    ...
    def text_direction_validate_enum(cls, value):
        ...
        if value not in set(['rtl', 'ltr']):
            raise ValueError("must be one of enum values ('rtl', 'ltr')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CookbookExtractGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CookbookExtractGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "meta": obj.get("meta"),
            "properties": CookbookExtractGet200ResponseProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "domain": obj.get("domain"),
            "title": obj.get("title"),
            "authors": String.from_dict(obj["authors"]) if obj.get("authors") is not None else None,
            "site": obj.get("site"),
            ...
            "html": obj.get("html"),
            "embed": obj.get("embed"),
            "images": CookbookExtractGet200ResponseImages.from_dict(obj["images"]) if obj.get("images") is not None else None
        })
        return _obj
