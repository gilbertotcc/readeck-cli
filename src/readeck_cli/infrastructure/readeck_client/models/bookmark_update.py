...
class BookmarkUpdate(BaseModel):
    ...
    BookmarkUpdate
    """ # noqa: E501
    title: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(default=None, description="New bookmark's title")
    description: Optional[StrictStr] = Field(default=None, description="Bookmark's description")
    site_name: Optional[StrictStr] = Field(default=None, description="Bookmark's site name")
    authors: Optional[List[StrictStr]] = Field(default=None, description="Bookmark's author list")
    published: Optional[Any] = Field(default=None, description="Bookmark's publication date")
    lang: Optional[StrictStr] = Field(default=None, description="Language Code")
    text_direction: Optional[StrictStr] = Field(default=None, description="Direction of the article's text. ")
    note: Optional[StrictStr] = Field(default=None, description="Bookmark's user note, text only. ")
    is_marked: Optional[StrictBool] = Field(default=None, description="Favorite state")
    is_archived: Optional[StrictBool] = Field(default=None, description="Archive state")
    is_deleted: Optional[StrictBool] = Field(default=None, description="If `true`, schedules the bookmark for deletion, otherwise, cancels any scheduled deletion ")
    ...
    read_anchor: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="CSS selector of the last seen element")
    labels: Optional[List[StrictStr]] = Field(default=None, description="Replaces the bookmark's labels")
    add_labels: Optional[List[StrictStr]] = Field(default=None, description="Add the given labels to the bookmark")
    remove_labels: Optional[List[StrictStr]] = Field(default=None, description="Remove the given labels from the bookmark")
    __properties: ClassVar[List[str]] = ["title", "description", "site_name", "authors", "published", "lang", "text_direction", "note", "is_marked", "is_archived", "is_deleted", "read_progress", "read_anchor", "labels", "add_labels", "remove_labels"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BookmarkUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BookmarkUpdate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "add_labels": obj.get("add_labels"),
            "remove_labels": obj.get("remove_labels")
        })
        return _obj
