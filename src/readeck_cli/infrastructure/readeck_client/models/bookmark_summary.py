...
class BookmarkSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "href", "created", "updated", "state", "loaded", "url", "title", "site_name", "site", "published", "authors", "lang", "text_direction", "document_type", "type", "has_article", "description", "note", "is_deleted", "is_marked", "is_archived", "read_progress", "labels", "word_count", "reading_time", "resources"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BookmarkSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BookmarkSummary from a dict"""
        if obj is None:
            return None
