...
from readeck_cli.infrastructure.readeck_client.models.bookmark_info_all_of_links import BookmarkInfoAllOfLinks
from readeck_cli.infrastructure.readeck_client.models.bookmark_summary_resources import BookmarkSummaryResources
...
class BookmarkInfo(BaseModel):
    ...
    BookmarkInfo
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Bookmark's ID")
    href: Optional[StrictStr] = Field(default=None, description="Link to the bookmark info")
    created: Optional[datetime] = Field(default=None, description="Creation date")
    updated: Optional[datetime] = Field(default=None, description="Last update")
    state: Optional[StrictInt] = Field(default=None, description="Indicates the state of the bookmark. - `0`: loaded - `1`: error - `2`: loading ")
    loaded: Optional[StrictBool] = Field(default=None, description="Becomes true when the bookmark is ready (regardless of its error state)")
    url: Optional[StrictStr] = Field(default=None, description="Bookmark's original URL")
    title: Optional[StrictStr] = Field(default=None, description="Bookmark's title")
    site_name: Optional[StrictStr] = Field(default=None, description="Bookmark's site name")
    site: Optional[StrictStr] = Field(default=None, description="Bookmark's site host name")
    published: Optional[Any] = Field(default=None, description="Publication date. Can be `null` when unknown.")
    authors: Optional[List[StrictStr]] = Field(default=None, description="Author list")
    lang: Optional[StrictStr] = Field(default=None, description="Language Code")
    text_direction: Optional[StrictStr] = Field(default=None, description="Direction of the article's text. It can be empty when it's unknown. ")
    document_type: Optional[StrictStr] = Field(default=None, description="The bookmark document type. This is usualy the same value as `type` but it can differ depending on the extraction process. ")
    type: Optional[StrictStr] = Field(default=None, description="The bookmark type. Unlike `document_type`, this can only be one of the 3 values. ")
    has_article: Optional[StrictBool] = Field(default=None, description="Indicates whether the bookmarks contains an article. Please not that there can be an article on any type. ")
    description: Optional[StrictStr] = Field(default=None, description="Bookmark's short description, when it exists. It's always an unformatted text. ")
    note: Optional[StrictStr] = Field(default=None, description="Bookmark's user note. Can be parsed as Markdown. ")
    is_deleted: Optional[StrictBool] = Field(default=None, description="`true` when the bookmark is scheduled for deletion. ")
    is_marked: Optional[StrictBool] = Field(default=None, description="`true` when the bookmark is in the favorites. ")
    is_archived: Optional[StrictBool] = Field(default=None, description="`true` when the bookmark is in the archives. ")
    read_progress: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(default=None, description="Reading progress percentage.")
    labels: Optional[List[StrictStr]] = Field(default=None, description="Bookmark's labels")
    word_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Number of words in the article, used to compute the reading time.")
    reading_time: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Duration of the article, in minutes. Either the actual duration for a video or a reading time based on the word count. ")
    resources: Optional[BookmarkSummaryResources] = None
    omit_description: Optional[StrictBool] = Field(default=None, description="`true` when the description was found at the content's beginning and can be hidden. ")
    read_anchor: Optional[StrictStr] = Field(default=None, description="CSS selector of the last seen element.")
    links: Optional[List[BookmarkInfoAllOfLinks]] = Field(default=None, description="This contains the list of all the links collected in the retrieved article. ")
    __properties: ClassVar[List[str]] = ["id", "href", "created", "updated", "state", "loaded", "url", "title", "site_name", "site", "published", "authors", "lang", "text_direction", "document_type", "type", "has_article", "description", "note", "is_deleted", "is_marked", "is_archived", "read_progress", "labels", "word_count", "reading_time", "resources", "omit_description", "read_anchor", "links"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['article', 'photo', 'video']):
            raise ValueError("must be one of enum values ('article', 'photo', 'video')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BookmarkInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BookmarkInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "has_article": obj.get("has_article"),
            "description": obj.get("description"),
            "note": obj.get("note"),
            "is_deleted": obj.get("is_deleted"),
            "is_marked": obj.get("is_marked"),
            "is_archived": obj.get("is_archived"),
            "read_progress": obj.get("read_progress"),
            "labels": obj.get("labels"),
            "word_count": obj.get("word_count"),
            "reading_time": obj.get("reading_time"),
            "resources": BookmarkSummaryResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
            "omit_description": obj.get("omit_description"),
            "read_anchor": obj.get("read_anchor"),
            "links": [BookmarkInfoAllOfLinks.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None
        })
        return _obj
