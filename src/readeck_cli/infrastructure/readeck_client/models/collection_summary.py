...
class CollectionSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["updated", "name", "is_pinned", "is_deleted", "search", "title", "author", "site", "type", "labels", "read_status", "is_marked", "is_archived", "range_start", "range_end"]
