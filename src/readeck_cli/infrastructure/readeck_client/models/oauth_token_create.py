...
from readeck_cli.infrastructure.readeck_client.models.oauth_token_create_one_of import OauthTokenCreateOneOf
from readeck_cli.infrastructure.readeck_client.models.oauth_token_create_one_of1 import OauthTokenCreateOneOf1
from pydantic import StrictStr, Field
from typing import Union, List, Set, Optional, Dict
from typing_extensions import Literal, Self

OAUTHTOKENCREATE_ONE_OF_SCHEMAS = ["OauthTokenCreateOneOf", "OauthTokenCreateOneOf1"]

class OauthTokenCreate(BaseModel):
    """
    OauthTokenCreate
    """
    # data type: OauthTokenCreateOneOf
    oneof_schema_1_validator: Optional[OauthTokenCreateOneOf] = None
    # data type: OauthTokenCreateOneOf1
    oneof_schema_2_validator: Optional[OauthTokenCreateOneOf1] = None
    actual_instance: Optional[Union[OauthTokenCreateOneOf, OauthTokenCreateOneOf1]] = None
    one_of_schemas: Set[str] = { "OauthTokenCreateOneOf", "OauthTokenCreateOneOf1" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = OauthTokenCreate.model_construct()
        error_messages = []
        match = 0
        # validate data type: OauthTokenCreateOneOf
        if not isinstance(v, OauthTokenCreateOneOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `OauthTokenCreateOneOf`")
        else:
            match += 1
        # validate data type: OauthTokenCreateOneOf1
        if not isinstance(v, OauthTokenCreateOneOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `OauthTokenCreateOneOf1`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in OauthTokenCreate with oneOf schemas: OauthTokenCreateOneOf, OauthTokenCreateOneOf1. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in OauthTokenCreate with oneOf schemas: OauthTokenCreateOneOf, OauthTokenCreateOneOf1. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into OauthTokenCreateOneOf
        try:
            instance.actual_instance = OauthTokenCreateOneOf.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into OauthTokenCreateOneOf1
        try:
            instance.actual_instance = OauthTokenCreateOneOf1.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into OauthTokenCreate with oneOf schemas: OauthTokenCreateOneOf, OauthTokenCreateOneOf1. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into OauthTokenCreate with oneOf schemas: OauthTokenCreateOneOf, OauthTokenCreateOneOf1. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], OauthTokenCreateOneOf, OauthTokenCreateOneOf1]]:
