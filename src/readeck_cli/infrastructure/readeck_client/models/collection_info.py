...
class CollectionInfo(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Collection's name")
    is_pinned: Optional[StrictBool] = Field(default=None, description="`true` when the collection is pinned ")
    is_deleted: Optional[StrictBool] = Field(default=None, description="Collection is scheduled for deletion")
    search: Optional[StrictStr] = Field(default=None, description="Search string")
    title: Optional[StrictStr] = Field(default=None, description="Title filter")
    author: Optional[StrictStr] = Field(default=None, description="Author filter")
    site: Optional[StrictStr] = Field(default=None, description="Site (name, host or domain) filter")
    type: Optional[List[StrictStr]] = Field(default=None, description="Type filter")
    labels: Optional[StrictStr] = Field(default=None, description="Label filter")
    read_status: Optional[List[StrictStr]] = Field(default=None, description="Read progress status")
    is_marked: Optional[StrictBool] = Field(default=None, description="Favorite filter")
    is_archived: Optional[StrictBool] = Field(default=None, description="Archive filter")
    range_start: Optional[StrictStr] = Field(default=None, description="From date filter")
    range_end: Optional[StrictStr] = Field(default=None, description="To date filter")
    id: Optional[StrictStr] = Field(default=None, description="Collection ID")
    href: Optional[StrictStr] = Field(default=None, description="Collection URL")
    created: Optional[datetime] = Field(default=None, description="Creation date")
    __properties: ClassVar[List[str]] = ["updated", "name", "is_pinned", "is_deleted", "search", "title", "author", "site", "type", "labels", "read_status", "is_marked", "is_archived", "range_start", "range_end", "id", "href", "created"]
    ...
    def type_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['article', 'photo', 'video']):
                raise ValueError("each list item must be one of ('article', 'photo', 'video')")
        return value

    @field_validator('read_status')
    def read_status_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        for i in value:
            if i not in set(['unread', 'reading', 'read']):
                raise ValueError("each list item must be one of ('unread', 'reading', 'read')")
        return value
