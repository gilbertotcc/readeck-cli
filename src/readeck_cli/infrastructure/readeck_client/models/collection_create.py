...
class CollectionCreate(BaseModel):
    ...
    CollectionCreate
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=128)] = Field(description="Collection's name")
    ...
    __properties: ClassVar[List[str]] = ["name", "is_pinned", "is_deleted", "search", "title", "author", "site", "type", "labels", "read_status", "is_marked", "is_archived", "range_start", "range_end"]
